...
_C.TEST.WEIGHT = "/home/cybercore/su/AICity2021-VOC-ReID/output/aicity20/0409-ensemble/r50-320-circle/best.pth"
...
_C.TEST.DO_RERANK = True
_C.TEST.RERANK_PARAM = [50, 15, 0.5]# K1, K2, LAMBDA
...
_C.TEST.ORI_DIST_PATH = './output/aicity20/0409-ensemble/orientation/feat_distmat.npy'
_C.TEST.CAM_DIST_PATH = './output/aicity20/0409-ensemble/ReCamID/feat_distmat.npy'
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
